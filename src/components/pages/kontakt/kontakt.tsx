...
function Kontakt() {
    return (
        <>
            ...
            <div className='kontakt-oppettider'>
                <div className="row">
                    <div className="col-sm-12 col-md-6">
                        <div className="card  mb-3;">
                            <div className="card-header text-white bg-dark"> <h3><b>ÖPPETTIDER</b></h3></div>
                    ...
                    <div className="col-sm-12 col-md-6">
                        <div className="card  mb-3;">
                            <div className="card-header text-white bg-dark"> <h3><b>KONTAKTUPPGIFTER</b></h3></div>
                            <div className="card-body">
                                <p className="card-text">
            ...
            <div className="col-sm-12 col-md-12 mt-5">
                <div className="card  mb-3;">
                    <div className="card-header text-white bg-danger"> <h3><b>HITTA TILL OSS</b></h3></div>
                    <div className="card-body">
